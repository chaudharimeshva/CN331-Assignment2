...
# Extracts unique DNS query URLs from the given .pcap files.
...
# We are running dig for every URL in this function which are present in files and return performanve matrix
